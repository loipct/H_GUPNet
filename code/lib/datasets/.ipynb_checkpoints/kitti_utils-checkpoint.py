...
class Calibration(object):
    ...
    def corners3d_to_img_boxes(self, corners3d):
        ...
        corners3d_hom = np.concatenate((corners3d, np.ones((corners3d.shape[0],corners3d.shape[1], 1))), axis=2)  # (N, 8, 4)
        ...
        boxes_corner = np.concatenate((x.reshape(-1, corners3d.shape[1], 1), y.reshape(-1,corners3d.shape[1], 1)), axis=2)
